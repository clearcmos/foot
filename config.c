...
add_default_key_bindings(struct config *conf)
{
    const struct config_key_binding bindings[] = {
        {BIND_ACTION_SCROLLBACK_UP_PAGE, m("none"), {{XKB_KEY_Prior}}},
        {BIND_ACTION_SCROLLBACK_UP_PAGE, m("none"), {{XKB_KEY_KP_Prior}}},
        {BIND_ACTION_SCROLLBACK_DOWN_PAGE, m("none"), {{XKB_KEY_Next}}},
        {BIND_ACTION_SCROLLBACK_DOWN_PAGE, m("none"), {{XKB_KEY_KP_Next}}},
        ...
        {BIND_ACTION_SEARCH_START, m(XKB_MOD_NAME_CTRL), {{XKB_KEY_f}}},
...
add_default_search_bindings(struct config *conf)
{
    const struct config_key_binding bindings[] = {
        ...
        {BIND_ACTION_SEARCH_FIND_NEXT, m("none"), {{XKB_KEY_Return}}},
        {BIND_ACTION_SEARCH_FIND_NEXT, m("none"), {{XKB_KEY_KP_Enter}}},
        {BIND_ACTION_SEARCH_FIND_PREV, m(XKB_MOD_NAME_SHIFT), {{XKB_KEY_Return}}},
        {BIND_ACTION_SEARCH_FIND_PREV, m(XKB_MOD_NAME_SHIFT), {{XKB_KEY_KP_Enter}}},
